...
<!-- Mirrored from themes.potenzaglobalsolutions.com/html/jobber/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Mar 2020 08:12:50 GMT -->
<head>
    <meta charset="utf-8">
    
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
    <title>FindMe! -The right place to be </title>
...
<!--=================================
Banner -->
<section class="banner bg-holder bg-overlay-black-30 text-white" style="background-image: url({{asset('img/bg/banner-01.jpg')}};">
  <div class="container">
    <div class="row">
      <div class="col-12 text-center">
        <h1 class="text-white mb-3">Déposez <span class="text-primary"> Votre CV  </span> <br> et obtenez votre emploi souhaité</h1>
        ...
        <div class="job-search-field">
          <div class="job-search-item">
            <form class="form row">
                ...
                <div class="form-group form-action" class="text-center">
                  <button type="submit" class="btn btn-primary btn-lg"><i class="fas fa-search"></i> POSTEZ UNE OFFRE </button>
                </div>
              </div>
            </form>
          </div>
                  ...
                  <div class="job-list-details">
                    <div class="job-list-info">
                      <div class="job-list-title">
                        <h5 class="mb-0"><a href="job-detail.html">{{$offre->titre_emploi}}</a></h5>
                      </div>
                      <div class="job-list-option">
                        <ul class="list-unstyled">
                          <li>
                            <span>via</span>
                            <a href="employer-detail.html">{{$offre->secteur_emploi}}</a>
                          </li>
                          <li><i class="fas fa-map-marker-alt pr-1"></i>{{$offre->ville}}</li>
                          <li><i class="fas fa-filter pr-1"></i>{{$offre->type_emploi}}</li>
